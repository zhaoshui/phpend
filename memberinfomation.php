           ...
           <div class="row">
               <div class="col-md-3"">
                   <div class="panel panel-default">
                       <h4 class="text-center">条件筛选查询</h4>
                       ...
                       <div class="modal  fade" id="new-screen-modal" tabindex="-1" role="dialog" aria-hidden="true">
                           <div class="modal-dialog">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-footer">
                                       <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-minus"></span> 取消</button>
                                       <button type="button" class="btn btn-primary"  data-dismiss="modal"> <span class="glyphicon glyphicon-screenshot"></span> 确定</button>
                                   </div>
                               </div>
                           </div>
                       </div>
                                   ...
                                   <div class="modal-body">
                                       <form role="form" action="javascript:void(0)">
                                          <div class="input-group">
                                             <span class="input-group-addon">网名/id</span>
                                             <input class="form-control" type="text" placeholder="请输入网名/id">
                                          </div>
                                           <div class="input-group">
                                               <span class="input-group-addon">姓名/名称</span>
                                               <input class="form-control" type="text" placeholder="请输入姓名/名称">
                                            </div>
                                          <div class="input-group">
                                             <span class="input-group-addon">省</span>
                                             <input class="form-control" type="text" placeholder="省">
                                          </div>
                                          <div class="input-group">
                                           ...
                                           <div class="input-group">
                                             <span class="input-group-addon">手机/电话</span>
                                             <input class="form-control" type="text" placeholder="手机/电话">
                                          </div>
                                          <div class="input-group">
                                             <span class="input-group-addon">会员等级</span>
                                             <input class="form-control" type="text" placeholder="会员等级">
                                          </div>
                                          <div class="input-group">
                                             <span class="input-group-addon">消费次数</span>
                                             <input class="form-control" type="text" placeholder="消费次数">
                                          </div>
                                          <div class="input-group">
                                             <span class="input-group-addon">消费金额</span>
                                             <input class="form-control" type="text" placeholder="消费金额">
                                          </div>
                                          <div class="input-group">
                                             <span class="input-group-addon">最近消费</span>
                                             <input class="form-control" type="text" placeholder="最近消费">
                                          </div>
                                          <div class="input-group">
                                             <span class="input-group-addon">登记时间</span>
                                             <input class="form-control" type="text" placeholder="登记时间">
                                          </div>
                                       </form>
                                   </div>
                                   <div class="modal-footer">
                                       <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-minus"></span> 取消</button>
                                       <button type="button" class="btn btn-primary"  data-dismiss="modal" id="new-btn-build"><span class="glyphicon glyphicon-ok" ></span>  确定</button>
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="modal fade" id="new-edit-modal" tabindex="-1" role="dialog" aria-hidden="true">
                           <div class="modal-dialog">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-footer">
                                       <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-minus"></span> 取消</button>
                                       <button id="new-btn-edit" type="button" class="btn btn-primary" data-dismiss="modal" ><span class="glyphicon glyphicon-edit"></span>  确定</button>
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="modal fade" id="new-deleate-modal" tabindex="-1" role="dialog" aria-hidden="true">
                           <div class="modal-dialog">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-footer">
                                       <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-minus"></span> 取消</button>
                                       <button type="button" class="btn btn-primary" data-dismiss="modal" id="new-btn-delate"><span class="glyphicon glyphicon-ok"></span>  确定</button>
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="modal fade" id="new-sms-modal" tabindex="-1" role="dialog" aria-hidden="true">
                           <div class="modal-dialog">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-footer">
                                       <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-minus"></span> 取消</button>
                                       <button type="button" class="btn btn-primary"  data-dismiss="modal"><span class="glyphicon glyphicon-send"></span>  确定</button>
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div>
                           <div class="panel panel-default">
                               ...
                               <div class="panel-body">
                                    <div class="btn-group">
                                           <button id="btn-sms" type="button" class="btn btn-primary" data-toggle="modal" data-target="#new-sms-modal">
                                       ...
                                       <div class="btn-group">
                                           <button type="button" class="btn btn-primary"  id="btn-keyaccount" data-toggle="modal" data-target="#new-keyaccount-modal" >
                                    ...
                                    <div id="toolbar">
                                       <div class="btn-group">
                                           ...
                                           <button id="btn-build" type="button" class="btn btn-default" data-toggle="modal" data-target="#new-build-modal" >
                                               <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                               新增
                                           </button>
                                           <button id="btn-edit" type="button" class="btn btn-default" data-toggle="modal" data-target="#new-edit-modal">
                                               <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                               修改
                                           </button>
                                           <button id="btn-deleate" type="button" class="btn btn-default" data-toggle="modal" data-target="#new-deleate-modal">
                                               <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                               删除
                                           </button>
                                          <!--  <button id="new-search" type="button" class="btn btn-default" data-toggle="modal" data-target="#new-search-modal">
                                   ...
                                   <script>
                                       ...
                                       function initTable() {
                                           ...
                                           $build.click(function(){
                                                alert($('#new-btn-build-name').val()+'+'+$('#new-btn-build-age').val())
                                                var ids = getIdSelections();
