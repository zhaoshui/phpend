                       ...
                       <div class="modal fade" id="new-build-modal" tabindex="-1" role="dialog" aria-hidden="true">
                           <div class="modal-dialog">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-footer">
                                       <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-minus"></span> 取消</button>
                                       <button type="button" class="btn btn-primary"  data-dismiss="modal" id="btn-build"><span class="glyphicon glyphicon-ok" ></span>  提交</button>
                                   </div>
                               </div>
                           </div>
                       </div>
                               ...
                               <div class="panel-body">
                                   <div id="toolbar">
                                       <!-- <div class="btn-group">
                                           ...
                                           <button id="btn-build" type="button" class="btn btn-primary" data-toggle="modal" data-target="#new-build-modal">
                                       ...
                                       function initTable() {
                                           ...
                                           $build.click(function(){
                                                ...
                                                $table.bootstrapTable('insertRow',{
                                                  index:0,
                                                  row:{"id":"0","user_id":"网名","user_name":"李不四","user_province":"河北","user_city":"廊坊","user_mobile":"12546983278","user_level":"初级用户","user_times":"102","user_amount":"173","user_lastconsum":"2017-03-27","user_lasttime":"2016-07-18"}
                                                })
                                           });
